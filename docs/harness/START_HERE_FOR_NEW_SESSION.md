...
- **P11-PILOT-1**: PASS.
- **P12**: Owner override — UI improvements during validation window. P12-000 done. P12-M1 (Tailwind) done. P12-M2 (Loading/Error) done. P12-M3 (i18n) ready_with_approval. P12-M4-M7 blocked.
