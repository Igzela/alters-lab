...
- **P11**: Product Completeness Before Validation. P11-000 done (planning stub). P11-M1 done (app capability inventory). P11-M1-R1 done (inventory granularity: data record inventory, per-route granularity, user workflow inventory, corrected overclaims). P11-M2 next (missing core workflow map).
