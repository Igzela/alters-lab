...
- **P6 validation**: Started 2026-05-28. P6 state: `CODE_COMPLETE / VALIDATION_IN_PROGRESS / NOT_SEALED`. P6 is NOT validated, NOT sealed. Completes after 4 real weekly reviews, 4 calibration records, 1 pattern review, 21 days / 4 ISO weeks. Prior pilot/smoke evidence does NOT count for completion.
