...
- **P9**: P9-000 done. P9-M1 done (install/launch/uninstall docs). P9-M2 done (disposable dpkg lifecycle verification — actual install/upgrade/remove in fakeroot). P9-M3 ready_with_approval (first-run onboarding guide). Rest blocked.
