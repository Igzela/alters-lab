# P10-M6 Week 2 Validation Evidence Template

Fill this template after executing Week 2 packaged-app operations.

## Expected Counters After Week 2

| Counter | Expected |
|---------|----------|
| weekly_reviews_after_start | 2 |
| calibration_or_action_alignment_records_after_start | 2 |
...
```yaml
p10_m6_week2_validation_evidence:
  date: <YYYY-MM-DD>
  ...
  completion_counter_after_week2:
    real_weekly_reviews_after_start: 2
    calibration_or_action_alignment_records_after_start: 2
    pattern_reviews_after_start: <0 or 1>
