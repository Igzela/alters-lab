...
| P7-M5 | Debian Package Build | ready_with_approval | P7-M4 | `.deb` installs app code to `/opt/alters-lab`, launcher to `/usr/bin/alters-lab`, desktop file to `/usr/share/applications` | Package writes or owns user runtime data |
