...
| P7-M8 | Local App Release Candidate | ready_with_approval | P7-M7 | Install deb, start app, open frontend, show provider status, run weekly review, store record in user data dir, P6 remains not sealed | Smoke test requires coding tools or mutates active YAML/rubric |
