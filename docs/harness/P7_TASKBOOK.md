...
| P7-M6 | Desktop Integration | ready_with_approval | P7-M5 | Desktop launcher starts local app and opens browser to local UI | Launcher depends on repo checkout or dev tooling |
