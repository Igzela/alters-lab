...
| P7-M7 | Upgrade / Uninstall / Data Safety | ready_with_approval | P7-M6 | Upgrade preserves user data; uninstall preserves data unless explicit purge; backup/export command exists | Upgrade/uninstall deletes user config, data, logs, or secrets by default |
