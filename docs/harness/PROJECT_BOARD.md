...
| P8-M4 | Weekly Review Assistant Mode | **ready_with_approval** |
| P8-M5 | E2E Product Validation | **blocked** |
| P8-M6 | Provider Safety Audit | **blocked** |
| P8-M7 | P8 Closeout | **blocked** |

P6 status: **CODE_COMPLETE / NOT_VALIDATED / NOT_SEALED** — P6 real-use validation is parked/postponed. It has not started, has not passed, and P6 is not sealed.
P8 status: **in_progress** — P8-000 plan complete, P8-M1 done, P8-M2 done, P8-M3 done, P8-M4 ready_with_approval, P8-M5 through P8-M7 blocked.
...
- P8-000 done. Real provider and product readiness boundary plan created. P8-M1 done (provider adapter contract hardened). P8-M2 done (connectivity check with /models endpoint, exact confirmation gating, fake http_client in tests). P8-M3 done (provider-backed dialogue preview with /chat/completions, injectable http_client, prompt/system_prompt capping). P8-M4 ready_with_approval. P8-M5 through P8-M7 blocked. P8 is not sealed. 1117 backend tests passing.
