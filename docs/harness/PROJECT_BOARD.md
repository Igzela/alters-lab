...
| P8-M3 | Provider-Backed Dialogue Preview | **ready_with_approval** |
...
P8 status: **in_progress** — P8-000 plan complete, P8-M1 done, P8-M2 done, P8-M3 ready_with_approval, P8-M4 through P8-M7 blocked.
...
- P8-000 done. Real provider and product readiness boundary plan created. P8-M1 done (provider adapter contract hardened). P8-M2 done (connectivity check with /models endpoint, exact confirmation gating, fake http_client in tests). P8-M3 ready_with_approval. P8-M4 through P8-M7 blocked. P8 is not sealed. 1080 backend tests passing.
