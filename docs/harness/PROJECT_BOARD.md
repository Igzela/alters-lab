...
P6 status: **CODE_COMPLETE / NOT_VALIDATED / NOT_SEALED** — P8 status: **sealed as REAL_PROVIDER_READY_LOCAL_APP** — All P8 milestones done. 1215 backend tests passing.
...
| P9-M1 | User-facing install / launch / uninstall docs | **ready_with_approval** |
| P9-M2 | Disposable install/upgrade/remove verification | **blocked** |
| P9-M3 | First-run onboarding guide | **blocked** |
| P9-M4 | Provider setup and safety guide | **blocked** |
...
P6 status: **CODE_COMPLETE / NOT_VALIDATED / NOT_SEALED** — P8 status: **sealed as REAL_PROVIDER_READY_LOCAL_APP** — P9 status: **P9-000 done, P9-M1 ready_with_approval** — 1215 backend tests passing.
...
- P8 sealed as REAL_PROVIDER_READY_LOCAL_APP. All milestones done: P8-000 plan, P8-M1 provider adapter contract, P8-M2 connectivity check, P8-M3 dialogue preview, P8-M4 weekly review assistant, P8-M5 E2E smoke, P8-M6 provider safety audit (7 sections all PASS), P8-M7 closeout. 1215 backend tests passing. Provider safety audit covers: grep scan, route audit, live constants, schema safety, evidence contract, secret policy, mutation boundary. No real provider calls by default. No provider output in committed evidence. No secrets committed. P6 remains NOT_VALIDATED/NOT_SEALED.
