...
P6 status: **CODE_COMPLETE / NOT_VALIDATED / NOT_SEALED** — P8 status: **sealed as REAL_PROVIDER_READY_LOCAL_APP** — P9 status: **P9-000 done, P9-M1 done, P9-M2 ready_with_approval** — 1215 backend tests passing.
