...
mkdir -p "$DATA_DIR/alters/product/forecast_snapshots"
mkdir -p "$DATA_DIR/alters/product/forecast_evaluations"
mkdir -p "$DATA_DIR/alters/product/external_evidence"
mkdir -p "$DATA_DIR/alters/product/predictor_profiles"
mkdir -p "$DATA_DIR/alters/product/branch_outcome_targets"
mkdir -p "$DATA_DIR/alters/product/calibration_conversations"
mkdir -p "$DATA_DIR/alters/product/calibration_drafts"
mkdir -p "$DATA_DIR/alters/product/branch_milestones"
mkdir -p "$DATA_DIR/alters/product/literature_priors"
mkdir -p "$DATA_DIR/alters/product/model_cards"
mkdir -p "$DATA_DIR/alters/product/population_prior_artifacts"
mkdir -p "$CONFIG_DIR"
